...
def choose_col_encode_ui(col):
  ...
  with c2:
    if col.nunique() > 20:
      st.write(
        "This feature has more than 20 unique values! "
        "It will be automatically removed. If needed, filter out values in the filter page."
      )
    else:
